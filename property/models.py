...
class Flat(models.Model):
    ...
    new_building = models.BooleanField('Новостройка или нет', null=True, blank=True, db_index=True)
    liked_by = models.ManyToManyField(User, related_name='user_likes', null=True, blank=True, verbose_name='Кто лайкнул:')
...
class Complaint(models.Model):
    ...
    apartments = models.ForeignKey(Flat, related_name='apartaments', on_delete=models.CASCADE, verbose_name='Квартира на которую жаловались:')
